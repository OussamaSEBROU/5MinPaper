    ...
    if st.session_state.view_pdf_checkbox:
        if st.session_state.uploaded_pdf:
            ...
            <object 
                ...
                <p>Your browser doesn't support PDF viewing, To enhance your experience : Open this App on a desktop (PC). 
...
def main():
    ...
    if st.button("Get Insights", key="insights_btn"):
        ...
        with st.spinner("Generating Insights..."):
            try:
                model = ChatGoogleGenerativeAI(model="gemini-2.0-flash-thinking-exp-1219", temperature=0.7)
                ...
                7. Output Direction and Consistency:
                        ...
                        - When the output contains a mix of Arabic and other languages, ensure the writing direction remains consistently right-to-left and left to right in good orginied shape to reading.
                ...
                9. Mathematical and Scientific Notation: For any (be carful) mathematical formulas, scientific symbols, or code snippets, present them like professional LaTeX font formatting for professional and accurate representation.
