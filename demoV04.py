...
<style>
    ...
    .stForm {
        ...
        background-color: white; /*Preserve background color*/
        z-index: 1000; /* Keep it on top */
    }

    /*  Optional: Add padding to the main app to prevent content from overlapping the form */
    .stApp {
        padding-bottom: 100px; /* Adjust as needed */
    }


    /* التأكد من وجود مساحة في أسفل الصفحة */
    .stApp {
        padding-bottom: 500px;
    }

    /* تصميم احترافي للإدخال */
